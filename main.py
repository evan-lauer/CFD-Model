...
from components.core import (
    SimulationConfig, StartCondition, SimulationRunner, Integrator
)
...
from components.plotting import plot_3d_paths, plot_topdown_paths
...
def build_runner() -> SimulationRunner:
    ...
    error = AR1VelocityErrorModel(
        rmse_horizontal_m_per_s=0.15, rmse_vertical_m_per_s=0.01, correlation_time_seconds=6*3600)
...
def build_start_conditions(initial_lat: float, initial_lon: float, initial_depth: float, n: int) -> list[StartCondition]:
